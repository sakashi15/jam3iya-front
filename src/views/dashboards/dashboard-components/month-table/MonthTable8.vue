...
export default {
  ...
  methods: {
    onSubmit(event) {
      ...
      this.isLoading = true
      this.$http.post("revenues/create", this.form)
          .then(response => {
    ...
    getAllRevenues() {
      this.isLoading = true
      this.$http.get("revenues/get-all")
          .then(response => {
            this.isLoading = false
            if(response.status === 200){
    ...
    onSubmit2(event) {
      ...
      this.showSuccess = false
      this.isLoading = true
      this.$http.post("revenues/update", this.form)
          .then(response => {
            this.isLoading = false
            if(response.status === 200){
              this.showSuccess = true
        ...
        centered: true
          ...
          .then(value => {
            ...
            if(value === true) {
              ...
              this.isLoading = true
              this.showError = false
              this.$http.post("revenues/delete", this.form)
                  .then(response => {
                    this.isLoading = false
                    if(response.status === 200){
                      this.show2 = false
